...
// wtxid of a coinbase is null_hash (BIP141), but Core displays this value.
...
DEFINE_JSON_FROM_TAGGED(bitcoind_tag, transaction)
{
    ...
    value =
    {
        ...
        // Core displays the witnessed serialization hash, even for a coinbase.
        { "hash", encode_hash(witnessed_hash(tx)) },
        // Core "size" is the witness-included total; (false) is base only.
